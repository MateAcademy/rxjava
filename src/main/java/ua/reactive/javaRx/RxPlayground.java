 ...
 * Observable генерирует потоки данных, трафик, event, информацию, событие, сообщения, месседжи, сигналы -> observer
 * Hot observable генерирует события вне зависимости подписан на него какой-то observer или нет
